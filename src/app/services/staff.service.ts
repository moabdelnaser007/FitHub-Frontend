...
export class StaffService {
  ...
  getStaffMembers(branchId: number): Observable<StaffMember[]> {
    ...
    return this.http.get<StaffListResponse>(url).pipe(
      map((response) => {
  ...
  getStaffMember(staffId: number): Observable<StaffMember> {
    return this.http.get<SingleStaffResponse>(`${this.apiUrl}/GetStaffMember/${staffId}`).pipe(
      map((response) => {
  ...
  deleteStaffMember(staffId: number): Observable<boolean> {
    ...
    return this.http.delete<DeleteStaffResponse>(url).pipe(
      map((response) => {
  ...
  assignStaffToBranch(staffId: number, branchId: number): Observable<boolean> {
    return this.http
      .get<AssignStaffResponse>(`${this.apiUrl}/AssignStaffToBranch/${staffId}/${branchId}`)
      .pipe(
        map((response) => {
          if (response.isSuccess) {
            return response.data;
  ...
  createStaff(staffData: CreateStaffRequest): Observable<any> {
    ...
    return this.http
      .post(
        `${environment.apiBaseUrl}/Auth/register-staff`,
        formData,
  ...
  updateStaffMember(staffId: number, staffData: UpdateStaffRequest): Observable<any> {
    return this.http
      .put<UpdateStaffResponse>(`${this.apiUrl}/UpdateStaffMember/${staffId}`, staffData)
      .pipe(
        map((response) => {
